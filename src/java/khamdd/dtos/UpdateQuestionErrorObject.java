 ...
 * @author KHAM
 */
public class UpdateQuestionErrorObject implements Serializable{
    private String questionError, answer1Error, answer2Error, answer3Error, answer4Error;

    public UpdateQuestionErrorObject() {
    }

    public UpdateQuestionErrorObject(String questionError, String answer1Error, String answer2Error, String answer3Error, String answer4Error) {
